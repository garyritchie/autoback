...
#AUTOBACKTM=/media/FNTM250TM/AUTOBACKTM 		## MULTI-BOOT cxmacwin01 (cygwin alias set)
#AUTOBACKTM=/cygdrive/t/AUTOBACKTM		## cxmacwin01 - Windows only. Set dedicated backup drive to T:.
AUTOBACKTM=/media/GLR500GBe/AUTOBACKTM		## @ home
